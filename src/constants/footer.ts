...
export const SOCIAL_LINKS: { label: string; href: string }[] = [
  { label: 'Facebook',  href: 'https://www.facebook.com/people/Vogel-Chile/61590711841020/' },
  { label: 'Instagram', href: 'https://www.instagram.com/vogel.chile?igsh=dDQ3ZTk5Znc2amtr' },
  { label: 'YouTube',   href: 'https://www.youtube.com/@VogelChile' },
]
